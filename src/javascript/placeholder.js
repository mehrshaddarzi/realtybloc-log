 ...
 */
rbl_js.placeholder = function (html = false) {
    return `
<div class="wps-ph-item">
    <div class="wps-ph-col-12">
        ${rbl_js.placeholder_content('picture')}
        ${rbl_js.placeholder_content('line')}
    </div>
    ` + (html !== false ? html : '') + `
</div>
`;
 ...
 * Line Placeholder
 */
rbl_js.line_placeholder = function (number = 1) {
 ...
 */
rbl_js.circle_placeholder = function () {
    return `
<div class="wps-ph-item">
     ${rbl_js.placeholder_content('circle')}
</div>
`;
};
 ...
 * Default Circle PlaceHolder
 */
rbl_js.rectangle_placeholder = function (cls = '') {
    return `
 ...
 * @param type
 */
rbl_js.placeholder_content = function (type = 'line') {
