<form action="<?php echo admin_url( 'admin.php' ); ?>" method="get" class="wps-inline" id="jquery-datepicker">
    ...
    <ul class="subsubsub wp-statistics-sub-fullwidth">
        ...
        <input type="hidden" name="<?php echo \REALTY_BLOC_LOG\Admin\User_History::$request_from_date; ?>" id="date-from" value="<?php echo $DateRang['from']; ?>">
        <input type="hidden" name="<?php echo \REALTY_BLOC_LOG\Admin\User_History::$request_to_date; ?>" id="date-to" value="<?php echo $DateRang['to']; ?>">
</form>
<?php
